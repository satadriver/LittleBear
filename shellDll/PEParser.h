...
public:
	...
	static bool PEParser::SetImageBase(char* chBaseAddress);

	static DWORD PEParser::GetImageBase(char* pFileBuff);

	static DWORD PEParser::GetSizeOfImage(char* pFileBuff);

	static int PEParser::loadPE();

	static int PEParser::CallConsoleEntry(char* chBaseAddress);

	static int PEParser::CallDllEntry(char* chBaseAddress);

	static int PEParser::CallExeEntry(char* chBaseAddress);
};
