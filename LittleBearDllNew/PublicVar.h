...
#ifndef PUBLICVAR_H_H_H
#define PUBLICVAR_H_H_H
...
#define SCHEDULE_RUN_MIN_INTERVAL		6
...
#define MAX_DLL_COUNT	64
#define MAX_ICON_COUNT	16




//task name and pe name can not be same,strange question
// #define BypassUacWithRegistryEventVwr							0
// #define BypassUacWithRegistryComMgmtLauncher						1
// #define UACBYPASS_CMD_TYPE_RUNEXE								1
// #define UACBYPASS_CMD_TYPE_RUNCMD								0
...
extern sockaddr_in stServDataAddr;
extern sockaddr_in stServCmdAddr;
extern sockaddr_in stServRemoteCtrlAddr;

extern int iProgramX86X64Value;
extern int iSystemVersion ;
extern int iCpuBits;
extern char strSysVersion[32];
extern char strPEResidence[MAX_PATH];
extern char strDllResidence[MAX_PATH];
extern char strBakPEResidence[MAX_PATH] ;
extern char strBakDllResidence[MAX_PATH] ;
...
extern char strLocalExternalIP[MAX_PATH];		//process is least with lots of chinese characters,so the buffer must be more larger
...
extern char strHostName[MAX_PATH];
extern char strComputerName[MAX_PATH];
extern char strUserName[MAX_PATH];
