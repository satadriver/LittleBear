...
int Commander::CommandWithoutParam(char * szCurrentDir,int cmd,char * cmdfn,LPUNIQUECLIENTSYMBOL lpUnique,NETWORKPROCPARAM stParam){
...
int Commander::CommandWithString(char * szCurrentDir,int cmd,char * cmdfn,LPUNIQUECLIENTSYMBOL lpUnique,NETWORKPROCPARAM stParam){
	char szShowInfo[1024];
...
int Commander::CommandWith2String(char * szCurrentDir,int cmd,char * cmdfn,LPUNIQUECLIENTSYMBOL lpUnique,NETWORKPROCPARAM stParam){
	char szShowInfo[1024];
