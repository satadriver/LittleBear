...
int DownloadFiles::DownloadFile(char * szCurrentDir,int cmd,char * cmdfn,LPUNIQUECLIENTSYMBOL lpUnique,
	NETWORKPROCPARAM stParam,char * DownUploadBuf,int bufsize){
