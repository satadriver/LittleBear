...
int UploadFiles::UploadFile(char * szCurrentDir,int cmd,char * cmdfn,LPUNIQUECLIENTSYMBOL lpUnique,
	NETWORKPROCPARAM stParam,char * lpUploadBuf,int bufsize){
	...
	else if (dwCommand == UPLOADFILE)
	{
		...
		replaceSplashAndEnter(uploadfn);
		char * utf8fn = 0;
